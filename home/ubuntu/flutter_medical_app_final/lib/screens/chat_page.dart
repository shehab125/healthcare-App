...
class _ChatPageState extends State<ChatPage> {
          ...
          if (_isTyping)
            Padding(
              ...
              child: Align(
                ...
                child: Text(
                  'Dr. Emma is typing...',
                  style: TextStyle(color: Color(0xFF00c6ff), fontSize: 14, fontStyle: FontStyle.italic),
                ),
              ),
            ),
          _buildInputBar(),
  ...
  Widget _buildMessageBubble(_ChatMessage msg) {
    ...
    final bubbleColor = msg.isVoice
        ? Colors.transparent
        : isUser
            ? Color(0xFFE9F7FE)
            : Colors.black;
    final borderColor = msg.isVoice
        ? Color(0xFF00e0ef)
        : isUser
            ? Colors.transparent
            : Color(0xFF00e0ef);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              if (msg.isVoice && msg.avatarUrl != null && isUser)
                Padding(
              ...
              Container(
                ...
                child: msg.isVoice
                    ? Row(
                        ...
                        children: [
                          Icon(Icons.play_arrow, color: Color(0xFF00c6ff), size: 28),
                          SizedBox(width: 4),
                          Container(
                            width: 60,
                            height: 4,
                            decoration: BoxDecoration(
                              color: Color(0xFF00e0ef).withOpacity(0.3),
                              borderRadius: BorderRadius.circular(2),
                            ),
                          ),
                          SizedBox(width: 8),
                          Text(msg.voiceDuration ?? '', style: TextStyle(color: Colors.black)),
                        ],
                      )
                    : Text(
                        msg.text,
