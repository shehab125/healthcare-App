...
class NotificationsPage extends StatelessWidget {
        ...
        'items': [
          {
            ...
            'desc': 'Your appointment with Dr. Smith is scheduled for tomorrow at 10:00 AM.',
            'time': '2m ago',
            'iconColor': cyan,
          },
          {
  ...
  Widget _filterButtonWithIcon(String label, IconData icon, Color color, {VoidCallback? onTap}) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
