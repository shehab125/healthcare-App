...
class DermatologyPage extends StatefulWidget {
  const DermatologyPage({super.key});

  @override
  State<DermatologyPage> createState() => _DermatologyPageState();
}

class _DermatologyPageState extends State<DermatologyPage> {
  String searchQuery = '';
  ...
  Widget build(BuildContext context) {
    final doctors = DoctorsData.dermatologyDoctors
        .where((doc) {
