...
class OncologyPage extends StatefulWidget {
  const OncologyPage({super.key});

  @override
  State<OncologyPage> createState() => _OncologyPageState();
}

class _OncologyPageState extends State<OncologyPage> {
  String searchQuery = '';
  ...
  Widget build(BuildContext context) {
    final doctors = DoctorsData.oncologyDoctors
        .where((doc) {
