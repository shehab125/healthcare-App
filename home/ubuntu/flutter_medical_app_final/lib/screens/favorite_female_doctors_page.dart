...
import 'favorite_female_doctors_page.dart';
class FavoriteFemaleDoctorsPage extends StatefulWidget {
  const FavoriteFemaleDoctorsPage({Key? key}) : super(key: key);

  @override
  State<FavoriteFemaleDoctorsPage> createState() => _FavoriteFemaleDoctorsPageState();
}

class _FavoriteFemaleDoctorsPageState extends State<FavoriteFemaleDoctorsPage> {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Image.asset('assets/favorite_female/Professional Doctor.png', width: 18, height: 18),
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                buildDoctorCard(
                  image: 'assets/favorite_female/Dr. Ava.png',
                  name: "Dr. Ava Williams, M.D.",
                  specialty: "Maternal-Fetal Medicine",
                  index: 0,
                ),
                buildDoctorCard(
                  image: 'assets/favorite_female/Dr. Chloe.png',
                  name: "Dr. Chloe Green, M.D.",
                  specialty: "Obstetrics and Gynecology (OB/GYN)",
                  index: 1,
                ),
                buildDoctorCard(
                  image: 'assets/favorite_female/Dr. Emily.png',
                  name: "Dr. Emily Wang",
                  specialty: "Neuro-Ophthalmologist",
                  index: 2,
                ),
                buildDoctorCard(
                  image: 'assets/favorite_female/Dr. Emma.png',
                  name: "Dr. Emma Hall, M.D.",
                  specialty: "General Doctor",
                  index: 3,
                ),
                buildDoctorCard(
                  image: 'assets/favorite_female/Dr. Hannah.png',
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Image.asset('assets/favorite_female/Home.png', width: 28, height: 28),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Image.asset('assets/favorite_female/Messages.png', width: 28, height: 28),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Image.asset('assets/favorite_female/User Profile.png', width: 28, height: 28),
            label: '',
          ),
          BottomNavigationBarItem(
